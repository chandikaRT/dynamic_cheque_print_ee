...
class dynamic_cheque_format_configuration(models.Model):
    ...
    _description = 'Dynamic Cheque Format Configuration'
    ...
    cheque_date_top_margin = fields.Float(string="Cheque Date Top Margin", default=8)
    cheque_date_left_margin = fields.Float(string="Cheque Date Left Margin", default=150)
    font_size_cheque_date = fields.Float(string="Cheque Date Font Size", default=5)
    cheque_date_spacing = fields.Float(string="Character Spacing", default=2)
    # Party's/Payee Name Configuration
    party_name_top_margin = fields.Float(string="Party Name Top Margin", default=22)
    party_name_left_margin = fields.Float(string="Party Name Left Margin", default=13)
    party_name_width_area = fields.Float(string="Party Name Width", default=167)
    font_size_party_name = fields.Float(string="Party Name Font Size", default=4)
    # Amount in words Configuration
    font_size_amt_word = fields.Float(string="Amount in Word Font Size", default=4)
    ...
    currency_name_position = fields.Selection([('before', 'Before'), ('after', 'After')], string="Currency Name Position",
                                              default='before')
    amount_word_type = fields.Selection([('standard', 'Standard'), ('capital', 'All Capital'),
                                         ('small', 'All Small'), ('capitalize', 'Capitalize')],
                                        default='standard', string="Amount in Word Type")
    # Amount in Figure Configuration
    font_size_amt_figure = fields.Float(string="Amount in Figure Font Size", default=5)
    amt_figure_top_margin = fields.Float(string="Amount in Figure Top Margin", default=34)
    amt_figure_left_margin = fields.Float(string="Amount in Figure Left Margin", default=155)
    amt_figure_width_area = fields.Float(string="Amount in Figure Width", default=41)
    currency_symbol = fields.Boolean(string="Currency Symbol", default=True)
    currency_symbol_position = fields.Selection([('before', 'Before'), ('after', 'After')], string="Currency Symbol Position",
                                              default='before')
    # Company Signatory Details
    company_name = fields.Boolean(string="Company Name", default=True)
    font_size_company_name = fields.Float(string="Company Name Font Size", default=4)
    company_name_top_margin = fields.Float(string="Company Name Top Margin", default=64)
    company_name_left_margin = fields.Float(string="Company Name Left Margin", default=147)
    # signator space
    cmp_signatory_width = fields.Float(string="Signatory Width", default=50)
    cmp_signatory_height = fields.Float(string="Signatory Height", default=10)
    cmp_signatory_top_margin = fields.Float(string="Signatory Top Margin", default=70)
    cmp_signatory_left_margin = fields.Float(string="Signatory Left Margin", default=147)
    # first signator
    font_size_first_signatory = fields.Float(string="First Signatory Font Size", default=3)
    first_signatory = fields.Char(string="Salutation of 1st Signatory")
    first_signatory_top_margin = fields.Float(string="First Signatory Top Margin", default=80)
    first_signatory_left_margin = fields.Float(string="First Signatory Left Margin", default=127)
    # second signator
    font_size_second_signatory = fields.Float(string="Second Signatory Font Size", default=3)
    second_signatory = fields.Char(string="Salutation of 2nd Signatory")
    second_signatory_top_margin = fields.Float(string="Second Signatory Top Margin", default=80)
    second_signatory_left_margin = fields.Float(string="Second Signatory Left Margin", default=144)
    # third signator
    font_size_third_signatory = fields.Float(string="Third Signatory Font Size", default=3)
    third_signatory = fields.Char(string="Salutation of 3rd Signatory")
    third_signatory_top_margin = fields.Float(string="Third Signatory Top Margin", default=80)
    third_signatory_left_margin = fields.Float(string="Third Signatory Left Margin", default=170)


class wizard_cheque_preview(models.TransientModel):
    _name = 'wizard.cheque.preview'
    _description = 'Wizard Cheque Preview'
...
class wizard_dynamic_cheque_print(models.TransientModel):
    ...
    _description = 'Wizard Dynamic Cheque Print'
